...
func main() {
	...
	var longBreakInterval *int = parser.Int("i", "interval", &argparse.Options{Required: false, Help: "Long break interval in minutes"})
	var totalPomodoros *int = parser.Int("t", "total", &argparse.Options{Required: false, Help: "Total pomodoros"})
